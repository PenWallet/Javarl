			...
			switch (opcion) //Según (opción)
			{
				case '1':
					...
					do
					{
						...
						if (caracterSuavizado1 != 'd' && caracterSuavizado1 != 'b' && caracterSuavizado1 != 'n' && caracterSuavizado1 != 'N' && caracterSuavizado1 != 'P')
							System.out.println("¡Solo d, b, n, V o P!");
					}while (caracterSuavizado1 != 'd' && caracterSuavizado1 != 'b' && caracterSuavizado1 != 'n' && caracterSuavizado1 != 'N' && caracterSuavizado1 != 'P');
					
					do
					{
						System.out.println("\nIntroduce el segundo:");
						caracterSuavizado2 = teclado.next().charAt(0);
						if (caracterSuavizado2 != 'd' && caracterSuavizado2 != 'b' && caracterSuavizado2 != 'n' && caracterSuavizado2 != 'N' && caracterSuavizado2 != 'P')
							System.out.println("¡Solo d, b, n, V o P!");
					}while (caracterSuavizado2 != 'd' && caracterSuavizado2 != 'b' && caracterSuavizado2 != 'n' && caracterSuavizado2 != 'N' && caracterSuavizado2 != 'P');
