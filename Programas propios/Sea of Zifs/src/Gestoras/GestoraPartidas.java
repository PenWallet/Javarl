...
public class GestoraPartidas {
    ...
    */
    ...
    /**
     * Carga la partida mediante el envío del objeto Jugador asociado a la partida cargada, y el envío de un array de
     * 180x44 con todos los caracteres del mapa asociado a la partida
     *
     * @param array El array que se
     * @return Array cargado con los caracteres del mapa
     */
    public Jugador cargarPartida(char[][] array)
    {
