 ...
 * 		- Altura: Int, consultable, modificable
 * 
...
public class Persona implements Cloneable
{
	...
	//Sobrecargado
	public Persona(String nombre, int edad, String dni, char sexo, int peso, int altura) throws PersonaException
	{
		/*if(edad < 0)
		{
	...
	public void setAltura(int altura) throws PersonaException
	{
		if(altura < 0)
			throw new PersonaException("¡Una persona no puede medir menos de 0 centímetros! El objeto '"+nombre+"' no se ha creado");
		else
...
*/
	...
	{
		String s = (nombre+","+edad+","+dni+","+sexo+","+peso+","+altura);
		return(s);
	}
